...
<body>
	...
	<div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					 <button type="button" class="btn btn-primary" id="printDetails">Print</button>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    { "data": "total_amount" },
					 {
                        ...
                        "render": function(data, type, row) {
                            if (data) {
                                return `<a href="view_bill.php?bill=${data}" target="_blank" class="btn btn-info">View Bill</a>`;
                            } else {
                                return `<span class="text-danger">No Bill</span>`;
                            }
                        }
                    },
            ...
            var printContent = document.getElementById('detailsContent').innerHTML;

...
<html>
<head>
  <title>HouseKeeping Issue Item</title>
...
<body>
  ...
  <form id="issueForm" class="issue__form">
    ...
    <div class="issue__head">
      <h1>HouseKeeping Issue Form</h1>
      <select name="issue_category" id="issue_category"  required title="Should select a Block" >
        <option value="">Select Block</option>
		<option value="GA">Girls A Block</option>
        <option value="GB">Girls B Block</option>
		<option value="GC">Girls C Block</option>
		<option value="GD">Girls D Block</option>
		<option value="GE">Girls E Block</option>
		<option value="BA">Boys A Block</option>
		<option value="BB">Boys B Block</option>
		<option value="BC">Boys C Block</option>
		<option value="BD">Boys D Block</option>
		<option value="BE">Boys E Block</option>
      </select>
	...
	<div class="print_issue__head">
		Selected Block: <span id="selectedIssueCategory"></span>
	</div>
			...
			<table>
			  ...
			  <tbody>
				...
				WHEN 'HouseKeeping' THEN 1 WHEN 'Milk' THEN 2 WHEN 'nonveg' THEN 3 WHEN 'veg' THEN 4 WHEN 'fruits' THEN 5 WHEN 'bakery' 
				THEN 6 WHEN 'one-use' THEN 7 ELSE 8 END AS item_category_value 
				FROM hk_stock c JOIN hk_item p ON c.itemid = p.id 
				...
				?>          
				  <tr class="<?=$class?>">
					...
					<td > <span class="available_quantity" name='aq[]'><?=strtoupper($row['quantity']); ?></span> <?=strtoupper($row['qunit']); ?></td>

...
<body>
    ...
    <main class="admin__main">
        <div class="admin__profile">
			...
			$photo=$user_name.".jpg";
            $sqlget = "SELECT * FROM admin WHERE user_name = ?";
        ...
        <section class="admin__right">
            ...
            <!-- Modal Structure -->
			 <div class="food__items">
				  <h2>The Mess Timings</h2>
				  <p>

					Breakfast: 7:00 AM – 8.00AM

					Lunch: As provided in the college timetable

					Tea: 4.30PM – 5.30PM

					Dinner: For girls 7:00PM – 8.00PM & For boys 8.00PM to 9.00PM
				</p>
            </div>
